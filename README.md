...
**Module:** `src/cuemspowerbridge/bridge.py`
...
**Module:** `src/cuemspowerbridge/config.py`
...
**Module:** `src/cuemspowerbridge/engine_state.py`
...
**Module:** `src/cuemspowerbridge/editor_client.py`
...
**Module:** `src/cuemspowerbridge/shelly.py`
...
**Module:** `src/cuemspowerbridge/network_map.py`
...
**Module:** `src/cuemspowerbridge/node_executor.py`
...
**Module:** `src/cuemspowerbridge/reachability.py`
...
**Module:** `src/cuemspowerbridge/osc_parse.py`
...
**Module:** `src/cuemspowerbridge/scripts/`
...
| Key | Default | Description |
|---|---|---|
| `ssh_user` | `cuems-admin` | Remote user for poweroff SSH (has a login shell + scoped NOPASSWD poweroff; the bridge key is locked to poweroff in its authorized_keys) |
...
| `controller_poweroff_cmd` | `""` | Optional override for the local controller's shutdown command. Empty → falls back to `poweroff_cmd`. Set to `sudo /usr/bin/systemctl reboot` for safe unattended testing — the controller self-recovers without relying on WoL or a physical power-on (WoL-from-S5 is verified working on this cluster's r8169 NICs, though r8169 WoL can be flaky across hardware generally) |
...
# Clone and build
git clone https://github.com/stagesoft/cuems-power-bridge.git
cd cuems-power-bridge
debuild -b -uc -us -nc
...
controller Wake-on-LAN from S5 is flaky across r8169 hardware generally (it is verified working on this cluster's NICs). `/usr/bin/`
...
[codecov.io/gh/stagesoft/cuems-power-bridge](https://codecov.io/gh/stagesoft/cuems-power-bridge)
...
[stagesoft.github.io/cuems-power-bridge](https://stagesoft.github.io/cuems-power-bridge/).
...
* A `pypi-publish.yml` GitHub Actions workflow to publish to PyPI on tagged releases,
  enabling `pip install cuemspowerbridge`.
...
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
[![Python 3.11+](https://img.shields.io/badge/python-3.11%2B-blue)](https://www.python.org)
[![Tests](https://github.com/stagesoft/cuems-power-bridge/actions/workflows/tests.yml/badge.svg)](https://github.com/stagesoft/cuems-power-bridge/actions/workflows/tests.yml)
[![Coverage](https://codecov.io/gh/stagesoft/cuems-power-bridge/graph/badge.svg)](https://codecov.io/gh/stagesoft/cuems-power-bridge)
[![Deploy MkDocs site](https://github.com/stagesoft/cuems-power-bridge/actions/workflows/gh-pages.yml/badge.svg)](https://github.com/stagesoft/cuems-power-bridge/actions/workflows/gh-pages.yml)
[![Upload Python Package](https://github.com/stagesoft/cuems-power-bridge/actions/workflows/pypi-publish.yml/badge.svg)](https://github.com/stagesoft/cuems-power-bridge/actions/workflows/pypi-publish.yml)
```
...
`cuems-power-bridge` is free software, distributed under the
